package com.a39275.wallet.adapter;
...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.card.setCardBackgroundColor(context.getResources().getColor(R.color.colorCartaoReceita));
        ...
        if (movimentacao.getTipo() == "d" || movimentacao.getTipo().equals("d")) {
            ...
            holder.valor.setText("-" + movimentacao.getValor() + " €");
            holder.card.setCardBackgroundColor(context.getResources().getColor(R.color.colorCartaoDespesa));
        }
    }
